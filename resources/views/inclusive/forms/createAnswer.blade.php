...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-user"></i> Registro de Respuestas</div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('StoreAnswer') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Respuesta Texto') }}</label>

                                        <div class="col-md-6">
                                            <input id="answertext" type="text"
                                                class="form-control @error('name') is-invalid @enderror"
                                                name="answertext" value="{{ old('answertext') }}" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="answervalue" required
                                            id="answervalue"></input>
                                    </div>
